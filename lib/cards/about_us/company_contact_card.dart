  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          _buildContactRow(context, Iconsax.call, 'Phone', phone),
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 16),
            child: Divider(height: 1, thickness: 0.5),
          ),
          _buildContactRow(context, Iconsax.sms, 'Email', email),
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 16),
            child: Divider(height: 1, thickness: 0.5),
          ),
          _buildContactRow(context, Iconsax.global, 'Website', website),
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 16),
            child: Divider(height: 1, thickness: 0.5),
          ),
          _buildContactRow(context, Iconsax.location, 'Address', address),
        ],
      ),
    );
  }
