        ...
        child: Row(
          children: [
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(16),
                child: stockist.photoUrl != null
                    ? (stockist.photoUrl!.startsWith('http')
                        ? Image.network(stockist.photoUrl!, fit: BoxFit.cover)
                        : Image.file(File(stockist.photoUrl!), fit: BoxFit.cover))
                    : const Icon(Iconsax.box, color: AppColors.coolGrey, size: 28),
              ),
            ),
