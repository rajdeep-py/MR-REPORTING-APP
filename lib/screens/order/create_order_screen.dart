  ...
  void _submit() {
    if (_selectedDoctor != null &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Please select doctor, shop, stockist and add at least one product',
          ),
        ),
      );
    }
                ...
                if (_tempItems.isEmpty)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: AppColors.coolGrey.withAlpha(20),
                      ),
                    ),
                    child: const Center(
                      child: Text(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildTextField('Quantity', _qtyCtrl, Iconsax.box, true),
              ),
            ],
          ),
